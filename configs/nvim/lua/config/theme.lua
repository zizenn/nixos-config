...
function M.apply()
  ...
  hi("StatusLineNC", { fg = c.on_surface_variant, bg = c.surface_variant })
  hi("TabLine", { fg = c.on_surface_variant, bg = c.surface_variant })
  hi("TabLineSel", { fg = c.on_primary, bg = c.primary_container, bold = true })
  hi("TabLineFill", { bg = c.surface_variant })
  hi("Pmenu", { fg = c.on_surface, bg = c.surface_variant })
  hi("PmenuSel", { fg = c.on_primary, bg = c.primary_container })
  ...
  hi("NonText", { fg = c.on_surface_variant })
  hi("Folded", { fg = c.on_surface_variant, bg = c.bg_hl })
  ...
  hi("TelescopeSelection", { fg = c.on_primary, bg = c.primary_container })
  ...
  hi("CmpItemMenu", { fg = c.on_surface_variant })

  -- Trouble
  hi("TroubleNormal", { fg = c.on_surface, bg = c.surface })
end
