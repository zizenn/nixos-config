{ lib, ... }: {
  homeManager.modules.base = { pkgs, ... }: {
    home.file = {
      ...
      ".cache/matugen/themes/nvim-colors.json".source = ./kanagawa-dragon/nvim-colors.json;
      ...
      ".config/matugen/kanagawa-dragon/swaylock.conf".source = ./kanagawa-dragon/swaylock.conf;
      ".config/matugen/kanagawa-dragon/kvantum/Matugen.kvconfig".source =
        ./kanagawa-dragon/kvantum/Matugen.kvconfig;
      ".config/matugen/kanagawa-dragon/kvantum/Matugen.svg".source =
        ./kanagawa-dragon/kvantum/Matugen.svg;
    };
  };
}
